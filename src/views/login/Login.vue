  ...
  methods:{
      tohome(){
          ...
          if(this.phonemessage==''){
              ...
              axios({
                  url:'https://treeholed.applinzi.com/treehole/index.php/Home/User/login',
                  method:'post',
                  data:postData
              }).then(res=>{
                console.log(res);
                      ...
                      var flag=confirm('登录成功');
                        if(flag){
                          ...
                          this.username=res.data.data.username;
                           this.$store.commit('getuserid',this.user_id);
                           this.$bus.$emit('loginsucess');
                           this.$emit('loginuserid',this.user_id);
                           this.$emit('loginusername',this.username);
                        }
                  }
              }).catch(err=>{
